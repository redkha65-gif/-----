...
ADMIN_TELEGRAM_IDS = [8632566020]

# معلومات المطور
DEVELOPER_INFO = "🛠 طُوِّر بواسطة: *𝙼𝙾𝙷𝙰𝙼𝙴𝙳 𝙺𝙸𝙽𝙶 𝙷𝙾𝚂𝚃*\n📬 تواصل: @mohamed_vip_1_1"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("💬 تواصل مع المطور @mohamed_vip_1_1", url="https://t.me/mohamed_vip_1_1")],
    ]
    await update.message.reply_text(
        ...
        "📬 تواصل مع المطور: @mohamed_vip_1_1\n\n"
        f"{DEVELOPER_INFO}",
        parse_mode="Markdown",
...
async def handle_api_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = api_request("/api/bot/verify", method="POST", data={"api_key": api_key})
    if not result or not result.get("success"):
        keyboard = [[InlineKeyboardButton("💬 تواصل مع المطور", url="https://t.me/mohamed_vip_1_1")]]
        await update.message.reply_text(
            "❌ *مفتاح API غير صالح!*\n\n"
...
def main():
    ...
    print("🚀 𝙼𝙾𝙷𝙰𝙼𝙴𝙳 𝙺𝙸𝙽𝙶 𝙷𝙾𝚂𝚃 Bot يعمل...")
