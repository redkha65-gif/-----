...
# ============== بيانات المسؤول ==============
ADMIN_USERNAME = "mohamedvip1"
ADMIN_PASSWORD_RAW = "mohamedvip1"

# ============== إعدادات البوت والإشعارات ==============
BOT_TOKEN = "8781810523:AAHT0uV89rOSSZ6TgTzhTbGjHLT-P0QV3po
ADMIN_TELEGRAM_ID = 8632566020
ADMIN_TELEGRAM_USERNAME = "@mohamed_vip_1_1"
...
def load_db():
    ...
    default_db = {
        ...
        "logs": [],
        "plans": {
            "free": {"name": "🎁 مجاني", "storage": 512000, "ram": 256, "cpu": 0.5, "max_servers": 3, "price": 0},
            "4gb": {"name": "💎 4 جيجا", "storage": 4096000, "ram": 1024, "cpu": 1, "max_servers": 6, "price": 5},
...
def add_server():
    ...
    if user_srv_count >= user.get("max_servers", 3):
        return jsonify({"success": False, "message": f"وصلت للحد الأقصى ({user.get('max_servers', 3)}) سيرفر."})
...
def bot_verify():
    ...
    return jsonify({
        ...
        "max_servers": user.get("max_servers", 3),
